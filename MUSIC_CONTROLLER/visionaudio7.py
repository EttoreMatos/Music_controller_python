...
class VisionAudioWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        content.addWidget(self._build_preview_column(), 3)
        content.addWidget(self._build_controls_column(), 2)
    ...
    def _build_preview_column(self) -> QFrame:
        ...
        self.led_preview = LedPreviewWidget()
        self.led_preview.setMinimumHeight(86)
        self.led_preview.setMaximumHeight(104)
        layout.addWidget(self.led_preview)

        self.timeline_widget = TimelineWidget()
        self.timeline_widget.setMinimumHeight(248)
        layout.addWidget(self.timeline_widget, 1)

        bottom = QSplitter(Qt.Horizontal)
        transition_panel = self._build_transition_panel()
        log_panel = self._build_log_panel()
        transition_panel.setMaximumHeight(138)
        log_panel.setMaximumHeight(138)
        bottom.addWidget(transition_panel)
    ...
    def _build_log_panel(self) -> QFrame:
        ...
        self.log_output.setMinimumHeight(54)
