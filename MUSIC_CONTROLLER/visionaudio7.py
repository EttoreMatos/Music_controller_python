...
def qt_message(parent: QWidget, title: str, message: str, level: str = "info") -> None:
    if level == "error":
...
class VisionAudioWindow(QMainWindow):
    ...
    def _apply_theme(self) -> None:
        ...
        palette.setColor(QPalette.Base, QColor("#1a1f27"))
        palette.setColor(QPalette.AlternateBase, QColor("#171c24"))
        palette.setColor(QPalette.Text, QColor("#f4f6fa"))
        palette.setColor(QPalette.WindowText, QColor("#f4f6fa"))
        palette.setColor(QPalette.Button, QColor("#252b35"))
        palette.setColor(QPalette.ButtonText, QColor("#f4f6fa"))
        self.setPalette(palette)
        self.setStyleSheet(
            """
            QMainWindow {
                background: qradialgradient(cx:0.12, cy:0.1, radius:1.05, fx:0.15, fy:0.12,
                    stop:0 #353f4f, stop:0.16 #252c37, stop:0.38 #191e26, stop:1 #0b0d12);
            }
            QLabel { color: #edf3fa; }
            QFrame#Card, QFrame#PlayerBar {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1,
                    stop:0 #2d3440, stop:0.07 #262d38, stop:0.48 #181d25, stop:1 #0d1015);
                border: 1px solid #434f61;
                border-radius: 20px;
            }
            QPushButton {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1,
                    stop:0 #4a586d, stop:0.08 #3d495d, stop:0.5 #2d3643, stop:0.51 #212733, stop:1 #151920);
                border: 1px solid #6e7c92;
                border-top-color: #95a3b8;
            ...
            QPushButton:hover {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1,
                    stop:0 #5f7088, stop:0.08 #4d5d72, stop:0.5 #323c4a, stop:1 #1c222b);
            }
            QPushButton:pressed {
                padding-top: 6px;
                padding-bottom: 2px;
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1,
                    stop:0 #151920, stop:0.35 #252d39, stop:1 #4b5d72);
            }
            QPushButton:disabled {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #252932, stop:1 #171b22);
                color: #788698;
                border-color: #3b4451;
            }
            QLineEdit, QComboBox, QSpinBox, QDoubleSpinBox, QListWidget, QPlainTextEdit {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #10141b, stop:1 #090c11);
                border: 1px solid #475466;
                border-top-color: #637184;
                border-radius: 10px;
                padding: 6px 9px;
                color: #edf3fa;
                selection-background-color: #ef8e2f;
                min-height: 18px;
            }
            QComboBox::drop-down {
                width: 28px;
                border-left: 1px solid #4c596b;
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #323b49, stop:1 #1c2129);
            ...
            QScrollBar::handle:vertical {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #667a92, stop:1 #36404d);
                border-radius: 7px;
                min-height: 28px;
            }
            ...
            QScrollBar::handle:horizontal {
                background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 #667a92, stop:1 #36404d);
                border-radius: 7px;
                min-width: 28px;
            }
            QSlider::groove:horizontal {
                height: 12px;
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #0a0d11, stop:1 #181d24);
                border: 1px solid #485569;
                border-radius: 6px;
            }
            QSlider::sub-page:horizontal {
                background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 #ff8b2b, stop:1 #ffd36c);
                border-radius: 5px;
            }
            QSlider::handle:horizontal {
                ...
                margin: -7px 0;
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1,
                    stop:0 #fdfefe, stop:0.14 #bcc7d4, stop:0.5 #7a8798, stop:0.51 #596473, stop:1 #272d38);
                border: 1px solid #d5dde7;
                border-bottom-color: #0d1016;
                border-radius: 11px;
            }
            QSlider::groove:vertical {
                width: 18px;
                background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 #090c10, stop:0.48 #1b2027, stop:1 #303845);
                border: 1px solid #4d5968;
                border-radius: 9px;
                margin: 4px 0;
            }
            QSlider::sub-page:vertical {
                background: qlineargradient(x1:0,y1:1,x2:0,y2:0, stop:0 #ea7f29, stop:0.5 #ffc36b, stop:1 #fff0a2);
                border-radius: 8px;
            }
            QSlider::add-page:vertical {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #1d232b, stop:1 #090c10);
                border-radius: 8px;
            }
            QSlider::handle:vertical {
                ...
                margin: 0 -7px;
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1,
                    stop:0 #fafcfe, stop:0.16 #cbd4df, stop:0.5 #8d99aa, stop:0.51 #626d7c, stop:1 #232933);
            ...
            QProgressBar {
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #10141b, stop:1 #090c11);
                border: 1px solid #475466;
                border-top-color: #68778c;
                border-radius: 10px;
                color: #f3f6fb;
                text-align: center;
            }
            QProgressBar::chunk {
                background: qlineargradient(x1:0,y1:0,x2:1,y2:0, stop:0 #ef7d27, stop:0.6 #fbbf54, stop:1 #fff1aa);
                border-radius: 8px;
            }
            QToolButton {
                color: #edf2f7;
                ...
                border-radius: 10px;
                padding: 5px 8px;
                background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #2d3643, stop:1 #161b23);
                font-weight: 700;
            }
            QGroupBox {
    ...
    def _build_ui(self) -> None:
        ...
        content.addWidget(self._build_monitor_column(), 1)
        content.addWidget(self._build_controls_column(), 3)
        content.addWidget(self._build_preview_column(), 2)
    ...
    def _build_header(self) -> QFrame:
        ...
        self.status_badge.setStyleSheet(
            """
            background: qlineargradient(x1:0,y1:0,x2:0,y2:1, stop:0 #3a4454, stop:0.5 #1d232c, stop:1 #11151b);
            border: 1px solid #7a889a;
            border-top-color: #b5c0cf;
            border-radius: 12px;
            padding: 8px;
            font-size: 12px;
            font-weight: 700;
        ...
        self.connection_label.setStyleSheet("color:#8da6c1;font-size:11px;")
        self.progress_label = QLabel("Aguardando acao")
        self.progress_label.setStyleSheet("color:#8da6c1;font-size:11px;")
    ...
    def _build_monitor_column(self) -> QFrame:
        ...
        title.setStyleSheet("font-size:12px;font-weight:700;color:#f0c36d;")
        layout.addWidget(title)

        self.led_preview = LedPreviewWidget()
        self.led_preview.setMinimumHeight(72)
        self.led_preview.setMaximumHeight(90)
        layout.addWidget(self.led_preview)

        transitions_card = self._build_transition_panel()
        transitions_card.setMaximumHeight(150)
        layout.addWidget(transitions_card)

        logs_card = self._build_log_panel()
        logs_card.setMaximumHeight(112)
    ...
    def _build_preview_column(self) -> QFrame:
        ...
        self.track_title_label.setStyleSheet("font-size:15px;font-weight:700;")
        self.track_meta_label = QLabel("")
        self.track_meta_label.setStyleSheet("color:#8da6c1;font-size:10px;")
        ...
        self.feature_summary_label.setStyleSheet("color:#b7c9dc;background:#0d1624;border:1px solid #22324b;border-radius:10px;padding:8px;font-size:10px;")
        layout.addWidget(self.feature_summary_label)

        self.timeline_widget = TimelineWidget()
        self.timeline_widget.setMinimumHeight(280)
        ...
        overview_title.setStyleSheet("font-size:12px;font-weight:700;color:#f0c36d;")
        overview_body = QLabel("Mapa principal da sequencia, estrutura e playback ao vivo.")
        overview_body.setWordWrap(True)
        overview_body.setStyleSheet("color:#90a3bb;font-size:10px;")
    ...
    def _build_transition_panel(self) -> QFrame:
        ...
        self.transition_list.setMinimumHeight(92)
        layout.addWidget(title)
    ...
    def _build_log_panel(self) -> QFrame:
        ...
        title.setStyleSheet("font-size:11px;font-weight:700;color:#f0c36d;")
        self.log_output = QPlainTextEdit()
        self.log_output.setReadOnly(True)
        self.log_output.setMinimumHeight(40)
        self.log_output.setMaximumHeight(54)
        layout.addWidget(title)
    ...
    def _build_profile_card(self) -> QFrame:
        ...
        for label_text, combo in (
            ...
            slot_label.setStyleSheet("font-size:10px;color:#b7c9dc;")
    ...
    def _build_player_bar(self) -> QFrame:
        ...
        self.player_title_label.setStyleSheet("font-size:12px;font-weight:700;")
        self.player_state_label = QLabel("Idle")
        self.player_state_label.setStyleSheet("color:#8da6c1;font-size:10px;")
        ...
        self.position_label.setStyleSheet("color:#8da6c1;font-size:10px;")
    ...
    def _apply_depth_effects(self) -> None:
        for widget in self.findChildren(QFrame):
            if widget.objectName() in {"Card", "PlayerBar"}:
                apply_drop_shadow(widget, blur_radius=36, y_offset=10, alpha=95)
        for button in self.findChildren(QPushButton):
            apply_drop_shadow(button, blur_radius=18, y_offset=4, alpha=90)
        apply_drop_shadow(self.status_badge, blur_radius=28, y_offset=6, alpha=95)
    ...
    def toggle_connection(self) -> None:
        try:
            ...
            self.log(f"Falha ao conectar Arduino: {exc}", "error")
            qt_message(self, "Arduino", str(exc), "error")

    def _set_busy(self, busy: bool, label: str = "Aguardando acao", value: int = 0) -> None:
        self.progress_label.setText(label)
        self.progress_bar.setValue(value)
        self.status_badge.setText(label if busy else "Ready")
    ...
    def _update_controls_enabled(self) -> None:
        self.suggest_button.setEnabled(self.current_track is not None)
        self.generate_button.setEnabled(self.current_track is not None)
        self.play_button.setEnabled(self.current_sequence is not None)
        self.stop_button.setEnabled(self.current_sequence is not None)
    ...
    def request_recommendation(self) -> None:
        ...
        self._recommend_worker.finished.connect(lambda: self._set_busy(False))
    ...
    def generate_sequence(self) -> None:
        ...
        self._generation_worker.finished.connect(lambda: self._set_busy(False))
    ...
    def _on_playback_error(self, message: str) -> None:
        self.log(f"Falha no player: {message}", "error")
        qt_message(self, "Player", message, "error")
    ...
    def _handle_worker_error(self, message: str) -> None:
        ...
        qt_message(self, APP_TITLE, message, "error")
